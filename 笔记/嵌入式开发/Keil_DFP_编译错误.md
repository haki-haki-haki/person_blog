# Keil STM32 编译报错 "\_Pos is undefined" 解决教程
...
```
error: #20: identifier "ADC_JSQR_JL_Pos" is undefined
error: #20: identifier "RCC_CR_HSITRIM_Pos" is undefined
error: #20: identifier "RCC_PLLCFGR_PLLN_Pos" is undefined
error: #20: identifier "CAN_FMR_CAN2SB" is undefined
...
```
...
```
stm32f4xx.h          (顶层选择器，根据 STM32F407xx 宏决定包含哪个)
  └── stm32f407xx.h   (真正的寄存器定义，1.2MB，包含所有 _Pos 宏)
