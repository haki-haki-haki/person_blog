...
$$
x_n &= x_{n-1} - \\frac{a x_{n-1}^3 - x_{n-1}}{2} \\\\
&= \\frac{3x_{n-1} - a x_{n-1}^3}{2}
$$\r
\r
## 存储形式\r
\r
...
\r
$$
\\log_2 \\dfrac{1}{\\sqrt{a}} = -\\dfrac{1}{2}\\left( \\dfrac{X_a}{2^{23}} + \\epsilon - 127 \\right) \\\\[6pt]
\\log_2 x = \\dfrac{X_x}{2^{23}} + \\epsilon - 127
$$\r
\r
化简得到\r
\r
...
\r
$$\r
\\int_{0}^{1}\\log_2(1+x)dx - (x+\\epsilon)dx &= 0 \\\\\r
\\int_{0}^{1}\\log_2(1+x)dx - \\int_{0}^{1}(x+\\epsilon)dx &= 0 \\\\\r
\\int_{0}^{1}\\log_2(1+x)dx &= \\int_{0}^{1}(x+\\epsilon)dx \\\\\r
\\frac{1}{\\ln 2}\\int_{1}^{2}\\ln u\\,du &= \\frac{1}{2}+\\epsilon \\\\\r
\\frac{1}{\\ln 2}\\left(2\\ln 2 - 1\\right) &= \\frac{1}{2}+\\epsilon \\\\\r
2 - \\frac{1}{\\ln 2} &= \\frac{1}{2}+\\epsilon \\\\\r
\\epsilon &= \\frac{3}{2} - \\frac{1}{\\ln 2}\r
$$\r
\r
